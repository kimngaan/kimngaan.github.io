...
/*-----------------------------------------------------------------------------------*/
	...
	function px_comment_fields($fields) {
		...
		$fields['author'] = "<div class=\"input-text\"><input name=\"author\" value=\"" . esc_attr($commenter['comment_author']) . "\" placeholder=\"" . __('Name *', TEXTDOMAIN) . "\" type=\"text\" tabindex=\"1\" required></div>";
		
		$fields['email'] = "<div class=\"input-text\"><input name=\"email\" value=\"" . esc_attr($commenter['comment_author_email']). "\" placeholder=\"" . __('Email *', TEXTDOMAIN) . "\" type=\"text\" tabindex=\"2\" required></div>";
		
		$fields['url'] = '<div  class="input-text"><input name="url" value="' . esc_attr($commenter['comment_author_url']). '" placeholder="' . __('Website', TEXTDOMAIN).'" type="text" tabindex="3"  ></div>';
			...
			<div id="comment-<?php comment_ID() ?>" <?php comment_class('clearfix'); ?> data-id="<?php comment_ID(); ?>">
                ...
                <div class="comment-content">
                    <div class="comment-meta">
                        ...
                        <a class="comment-date" href="<?php echo htmlspecialchars( get_comment_link( $comment->comment_ID ) ) ?>"><?php printf(__('%1$s AT %2$s', TEXTDOMAIN), get_comment_date(),  get_comment_time("g:i A")) ?></a>
                        <?php
...
'comment_field'=>'<div class="input-textarea"><textarea rows="10" cols="78" name="comment" placeholder="' . __('Your Message', TEXTDOMAIN).  '" tabindex="4"></textarea></div>',
'comment_notes_after' => '',
